...
/*
 * Proxy class for interface org.freedesktop.systemd1.Swap
 */
class OrgFreedesktopSystemd1SwapInterface: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    OrgFreedesktopSystemd1SwapInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);

    ~OrgFreedesktopSystemd1SwapInterface();
